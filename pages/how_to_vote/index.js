      ...
      <section className="HowToVote">
        ...
        <div className="row my-1">
          <div className="col-12">
            ...
            <div className="instruction-list">
              ...
              <div className="instruction">
                ပြည်သူ့လွှတ်တော် ဆန္ဒမဲပုံး ရှိရာသို့သွား၍ မဲပုံးထဲသို့ မဲလက်မှတ်ကိုထည့်ပါ။
              </div>
          </div>
          </div>
        </div>
        <div className="row my-1">
          <div className="col-12">
            ...
            <div className="instruction">
              အမျိုးသားလွှတ်တော် ကိုယ်စားလှယ် ဆန္ဒမဲအတွက် မဲစာရင်းစစ်သူထံ သွားရောက်၍ မှတ်ပုံတင်ပြသပါ။
            </div>
            <div className="instruction">
              မဲစာရင်းတွင် မိမိအမည်ပါလျှင် မဲလက်မှတ် ထုတ်ပေးသူထံမှ မဲလက်မှတ် ရယူပါ။
            </div>
            ...
            <div className="instruction">
              အမျိုးသားလွှတ်တော် ဆန္ဒမဲပုံး ရှိရာသို့သွား၍ မဲပုံးထဲသို့ မဲလက်မှတ်ကိုထည့်ပါ။
            </div>
          </div>
        </div>
        <div className="row my-1">
        ...
        <div className="row my-1">
          <div className="col-12">
            ...
            <div className="instruction">
              တိုင်းရင်းသားလူမျိုး ဆန္ဒမဲပုံး ရှိရာသို့သွား၍ မဲပုံးထဲသို့ မဲလက်မှတ်ကိုထည့်ပါ။
            </div>
          </div>
        </div>
        <div className="row my-1">
